  ...
  return (
    <div style={{ maxWidth: '1000px', margin: '40px auto', padding: '20px 40px' }}>
      ...
      <div style={{ display: 'flex', gap: '8px', marginBottom: '24px', flexWrap: 'wrap' }}>
        ...
        <button onClick={() => { setTab('create'); setShowCreate(true) }} style={{ padding: '10px 24px', background: tab === 'create' ? '#c9a84c' : '#111a14', color: tab === 'create' ? '#080c0a' : '#c9a84c', border: '1px solid #c9a84c', borderRadius: '4px', cursor: 'pointer', fontWeight: 'bold', fontSize: '13px', letterSpacing: '1px' }}>+ Found a Company</button>
      </div>
      ...
      {tab === 'create' && (
        <div style={{ background: '#111a14', border: '1px solid #c9a84c', borderRadius: '8px', padding: '32px', maxWidth: '500px' }}>
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            <input
              type="text"
              placeholder="e.g. Dean Industries"
              value={newCompany.name}
              onChange={(e) => setNewCompany({ ...newCompany, name: e.target.value })}
              style={{ width: '100%', padding: '12px', background: '#0d1410', border: '1px solid #1e2e22', borderRadius: '4px', color: '#f0f7f2', fontSize: '14px' }}
            />
          </div>
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <textarea
              ...
              rows={3}
              style={{ width: '100%', padding: '12px', background: '#0d1410', border: '1px solid #1e2e22', borderRadius: '4px', color: '#f0f7f2', fontSize: '14px', resize: 'vertical' }}
            />
          </div>
          ...
          <button
            ...
            disabled={creating}
            style={{ width: '100%', padding: '14px', background: '#c9a84c', color: '#080c0a', border: 'none', borderRadius: '4px', fontWeight: 'bold', fontSize: '14px', cursor: 'pointer', letterSpacing: '1px' }}
          >
            ...
            {selectedCompany ? (
              <div style={{ background: '#111a14', border: '1px solid #1e2e22', borderRadius: '8px', padding: '24px' }}>
                <div style={{ marginBottom: '20px' }}>
                  ...
                  <div style={{ color: '#c9a84c', fontWeight: 'bold', fontSize: '24px' }}>{selectedCompany.price.toFixed(2)} Beans/share</div>
                  <div style={{ color: '#6b8a72', fontSize: '12px', marginTop: '4px' }}>{selectedCompany.shares_available} of {selectedCompany.total_shares} shares available</div>
                </div>
